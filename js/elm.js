...
Elm.ElmDublin.make = function (_elm) {
   ...
   var update = F2(function (action,model) {
      ...
      if (_p4.ctor === "NoOp") {
            ...
            return A3($TransitRouter.update,routerConfig,_p4._0,model);
         }
   });
   var NoOp = {ctor: "NoOp"};
...
Elm.Pages.make = function (_elm) {
   ...
   _U.list([]),
   _U.list([A2($Html.h1,_U.list([]),_U.list([$Html.text("Elm Dublin User Group")])),A2($Html.p,_U.list([]),_U.list([$Html.text("Welcome!")]))]));
   ...
   var header = F2(function (action,model) {
      ...
      _U.list([A2($Html.ul,
      _U.list([]),
      _U.list([A2($Html.li,_U.list([]),_U.list([A2($Html.a,clickTo($Routes.encode($Routes.Home)),_U.list([$Html.text("Home")]))]))
              ,A2($Html.li,_U.list([]),_U.list([A2($Html.a,clickTo($Routes.encode($Routes.About)),_U.list([$Html.text("About")]))]))]))]))]));
   });
